...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmail=(EditText) findViewById(R.id.email_phone_Sign_up);
...
// Sign UP
                    ...
                    (new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(SignUpActivity.this, task.getException().getMessage()+"sign in problem", Toast.LENGTH_SHORT).show();
                            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // todo callbackManager.onActivityResult(requestCode, resultCode, data);
    }
    ...
    public void signUpByGoogle (View view){
        signIn();
    }
