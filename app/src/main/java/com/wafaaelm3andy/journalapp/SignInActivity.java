...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListener = new  FirebaseAuth.AuthStateListener(){
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser()!=null){
                    startActivity(new Intent(SignInActivity.this,BasicJournalActivity.class));
                }
        ...
        mEmail=(EditText) findViewById(R.id.email_phone);
                    ...
                    (new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(SignInActivity.this, task.getException().getMessage()+"sign in problem", Toast.LENGTH_SHORT).show();
                            }
